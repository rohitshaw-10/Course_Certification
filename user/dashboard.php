...
<head>
    ...
    <title>Dashboard | Online Course Certification Management System</title>
...
{               ?> 
                                        <div class="main-income-phara">
                                           <h2>Welcome to Online Course Certification Management System <?php  echo $row->FirstName;?>  <?php  echo $row->LastName;?>!!!</h2>
                                        </div>
                                        <?php $cnt=$cnt+1;}} ?>
                                    </div>
                                </div>
